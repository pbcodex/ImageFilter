...
;Process : Contrast (-255 à 255)
SetRawImageContrast(*RawImage, -100)

;Copie du résultat du process dans de sortie  
...
OpenWindow(1, 0, 0, ImageWidth(Image), ImageHeight(Image), "Image Contrast", #PB_Window_SystemMenu | #PB_Window_ScreenCentered)
